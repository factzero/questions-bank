...
func (*Local) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	if mkdirErr != nil {
		fmt.Println("function os.MkdirAll() Filed", mkdirErr.Error())
	...
	if createErr != nil {
		fmt.Println("function os.Create() Filed", createErr.Error())
	...
	if copyErr != nil {
		fmt.Println("function io.Copy() Filed", copyErr.Error())
