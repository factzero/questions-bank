...
export const getAuthorityList = (data) => {
  return service({
    url: "/api/v1/authority/getAuthorityList",
    method: "post",
    data,
  });
};
...
export const deleteAuthority = (data) => {
  return service({
    url: "/api/v1/authority/deleteAuthority",
    method: "post",
    data,
  });
};
...
export const createAuthority = (data) => {
  return service({
    url: "/api/v1/authority/createAuthority",
    method: "post",
    data,
  });
};
...
export const copyAuthority = (data) => {
  return service({
    url: "/api/v1/authority/copyAuthority",
    method: "post",
    data,
  });
};
...
export const setDataAuthority = (data) => {
  return service({
    url: "/api/v1/authority/setDataAuthority",
    method: "post",
    data,
  });
};
...
export const updateAuthority = (data) => {
  return service({
    url: "/api/v1/authority/updateAuthority",
    method: "put",
    data,
  });
};
