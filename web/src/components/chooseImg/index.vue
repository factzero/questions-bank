  ...
  <el-drawer v-model="drawer" title="媒体库" size="650px">
    ...
    <div class="gva-btn-list">
      ...
      <el-form ref="searchForm" :inline="true" :model="search">
        ...
        <el-form-item>
          <el-button size="small" type="primary" icon="search" @click="open"
            >查询</el-button
          >
        </el-form-item>
      </el-form>
      ...
      <div v-for="(item, key) in picList" :key="key" class="media-box">
        <div class="header-img-box-list">
          <el-image
            :key="key"
            :src="
              item.url && item.url.slice(0, 4) !== 'http'
                ? path + item.url
                : item.url
            "
...
<script setup>
import { ref } from "vue";
import { getFileList, editFileName } from "@/api/system/fileUploadAndDownload";
